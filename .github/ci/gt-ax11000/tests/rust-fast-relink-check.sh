...
grep -Fq '$(PROFILE_DIR)/fs.install/shared/usr/sbin/wlif-exec' "$repack_make"
grep -Fq 'usr/sbin/wlif-exec' "$overlay_root/build.sh"
grep -Fq 'usr/sbin/wlif-exec' "$source_root/release/src/router/shared/Makefile"
